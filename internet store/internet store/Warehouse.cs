...
namespace online_store
{
    public class Warehouse : IWarehouse
    {
        ...
        public void Delive(Product product, int productCount)
        {
            if (product == null)
        ...
        public bool IsStock(string name, int count)
        {
            if (name == null)
            ...
            if (_cells.ContainsKey(name) == false)
                throw new InvalidOperationException($"Product {name} is not in the collection");

            return _cells[name].Count <= count;
        }
        ...
        public void ReserveProduct(string name, int count)
        {
            if (name == null)
                throw new ArgumentNullException(nameof(name));
